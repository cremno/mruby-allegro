...
mruby_allegro_mouse_init(mrb_state *mrb)
{
  ...
  mrb_define_class_method(mrb, mm, "install", install, MRB_ARGS_NONE());
  mrb_define_class_method(mrb, mm, "installed?", installed, MRB_ARGS_NONE());
  mrb_define_class_method(mrb, mm, "uninstall", uninstall, MRB_ARGS_NONE());
  mrb_define_class_method(mrb, mm, "num_axes", num_axes, MRB_ARGS_NONE());
  mrb_define_class_method(mrb, mm, "num_buttons", num_buttons, MRB_ARGS_NONE());
  mrb_define_class_method(mrb, mm, "set_z", set_z, MRB_ARGS_REQ(1));
  mrb_define_class_method(mrb, mm, "set_w", set_w, MRB_ARGS_REQ(1));
  mrb_define_class_method(mrb, mm, "set_axis", set_axis, MRB_ARGS_REQ(2));
  mrb_define_class_method(mrb, mm, "event_source", event_source, MRB_ARGS_NONE());
  mrb_define_method(mrb, dc, "hide_mouse_cursor", hide_mouse_cursor, MRB_ARGS_NONE());
  mrb_define_method(mrb, dc, "show_mouse_cursor", show_mouse_cursor, MRB_ARGS_NONE());
  mrb_define_method(mrb, dc, "grab_mouse", grab_mouse, MRB_ARGS_NONE());
  mrb_define_class_method(mrb, mm, "ungrab", ungrab, MRB_ARGS_NONE());
}
